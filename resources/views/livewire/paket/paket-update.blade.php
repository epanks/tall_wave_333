                    ...
                    <div class="flex flex-wrap -mx-3 mb-6">
                        <div class="w-full md:w-2/4 px-3 mb-6 md:mb-0">
                            ...
                            <div class="mb-5">
                                ...
                                <textarea type="text" rows="4" wire:model.lazy="nmpaket" placeholder="Nama Paket"
                                    id="nmpaket" class="w-full form-input "></textarea>
                                @error('nmpaket')
                            ...
                            <div class="mb-5">
                                ...
                                <select name="kdsatker" class="w-full form-input" wire:model="kdsatker">
                            ...
                            <div class="mb-5">
                                ...
                                <select class="w-full form-input" wire:model="ppk_id">
                                    ...
                                    @foreach ($this->filterppk as $item)
